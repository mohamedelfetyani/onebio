                ...
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="subheader d-flex flex-row">
                        <span class="text-muted">
                            <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://altumco.de/site" target="_blank" class="text-gray-500">AltumCode And Nulled By BlakenFist</a>
                        </span>
                    </p>
                </div>
            </div>
